...
# message_id → { title, lines, owners, channel_id }
sessions: dict[int, dict] = {}

# (message_id, slot_index) → [User, ...]
...
# ─── 8. Модал для причини та рішення ────────────────────────────────────────────
...
# ─── 9. Кнопки рішення адміністратора ──────────────────────────────────────────
