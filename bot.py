...
SLOT_KEYWORDS = [
    ...
    r'старший стрелок', r'гранатомётчик', r'пулемётчик', r'помощник', r'санитар',
    r'стрелок', r'помощник гранатомётчика', r'помощник пулемётчика',
    r'помощник снайпера', r'разведчик', r'медик\s*\|\s*MED', r'санитар\s*\|\s*MED'
]
